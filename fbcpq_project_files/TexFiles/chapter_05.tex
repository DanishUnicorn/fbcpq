...
\begin{enumerate}
    ...
    \begin{enumerate}
        ...
        \item Inferior flower quiality due to vigorous growth: In strawberries, high nitrogen or excessive vigor results in fewer pistils per flower and smaller trusses, leading to reduced potential berry size \cite*{rm_03_L04_flower_bud_formation}.
    \end{enumerate}
